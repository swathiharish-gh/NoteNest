...
const Faq = () => {
  ...
  return (
<div className="border border-rose-500 overflow-hidden">
  <div className="mx-auto max-w-[1550px] px-5 py-8">
  <h1 className="mb-6 text-3xl font-black border-b-2 border-rose-500 pb-2 flex justify-center items-center">Frequently Asked Questions</h1>
